 ...
 * @author CoNNect
 */
public class MainPageXOGameSignUp extends javax.swing.JFrame {
    GamePlayer user = new GamePlayer(); 
  
    public MainPageXOGameSignUp() {
        initComponents();
        centreWindow(this);
        this.setTitle("XO Game - Sign Up");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("XO Game - Sign Up");
    ...
    String msg=("Signup"+","+TxtUsername.getText()+","+TxtPassword.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainPageXOGameSignUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainPageXOGameSignUp().setVisible(true);
            }
        });
    }
